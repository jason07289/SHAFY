...
//			String[] csrfExecute = { "./csrf.sh" }; // 쉘 파일에 cmd 명령어 넣고 쉘 파일을 실행 -> 여기서 _csrf 토큰 값 받아오기 (String 쪼개서)
//			Process p = Runtime.getRuntime().exec(csrfExecute);
//			String userId = "lovemode1993@naver.com";
//
...
//			String[] authenticafionExecute = { "./authentication.sh", userId, csrf };
